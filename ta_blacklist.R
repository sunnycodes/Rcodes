...
black_list_raw<-read.csv(file='~/Desktop/blacklist_emails/black_list_final_list.csv', header=FALSE)
...
#************************************************************************************
write.csv (json_black_list_emails, file=paste('~/Desktop/blacklist_emails/Opted_out_Emails',Sys.Date(),'.csv'))
